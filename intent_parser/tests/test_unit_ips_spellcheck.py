...
from intent_parser.tests.ips_test_utils import compare_spell_results
from intent_parser.tests.ips_test_utils import get_currently_selected_text
...
class IpsSpellcheckTest(unittest.TestCase):
    ...
    def test_spellcheck_add_synbiohub_submit(self):
        ...
        self.ips.sbh_uri_prefix = 'https://hub-staging.sd2e.org/user/sd2e/src/'
        self.ips.sbh_collection_uri = 'https://hub.sd2e.org/user/sd2e/src/intent_parser_collection/1'
